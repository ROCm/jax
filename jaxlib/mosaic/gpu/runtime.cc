...
void abort_on_error(gpuError_t result, const char *fmt, Args &&...args) {
...
void mosaic_gpu_init_tma_desc(CUtensorMap *tma_desc, void *base_addr,
  ...
  abort_on_error(cuTensorMapEncodeTiled(tma_desc, data_type, rank, base_addr,
                                        tma_sizes, tma_strides,
                                        tma_window_shape, element_strides,
