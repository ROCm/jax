...
def lower_jaxpr_to_triton_module(
  ...
  # TODO(slebedev): Use backend_options= during lowering.
    ...
    "abs",
      { "cuda":
        [
          ...
          _Extern(["float32"], "__nv_fabs_f", "float32"),
          _Extern(["float64"], "__nv_fabs", "float64"),
        ],
        "rocm":
        [
          #\todo: rahbatra - add support for hip device functions
          #_Extern(["int32"], "__triton_hip_iabs", "int32"),
          #_Extern(["int64"], "__triton_hip_iabs", "int64"),
          #_Extern(["float32"], "__triton_hip_fabs", "float32"),
          #_Extern(["float64"], "__triton_hip_fabs", "float64"),
