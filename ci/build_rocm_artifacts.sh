...
# Local mode ignores $1 and builds the full set of wheels CI produces across
# its matrix: the pjrt wheel once (for the first Python version) and the plugin
# wheel for every Python version.
#
