...
WHEELS=( $(/usr/bin/find "$JAXCI_OUTPUT_DIR/" -type f \(  -name "*jax*py3*"  -o -name "*jax*cuda*pjrt*" -o -name "*jax*cuda*plugin*" -o -name "*jax*rocm*pjrt*" -o -name "*jax*rocm*plugin*" -o -name "*jaxlib*rocm*" \)) )
